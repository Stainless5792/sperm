...
#ifndef __SPERM_CC_COMMON_FAST_MEMCPY_H__
#define __SPERM_CC_COMMON_FAST_MEMCPY_H__
...
static inline void fast_memcpy(void* dst, const void* src, size_t size) {
  ...
  B1:
    return _fast_memcpy<1>(dst, src);
  B2:
    return _fast_memcpy<2>(dst, src);
  B3:
    return _fast_memcpy<3>(dst, src);
  B4:
    return _fast_memcpy<4>(dst, src);
  B5:
    return _fast_memcpy<5>(dst, src);
  B6:
    return _fast_memcpy<6>(dst, src);
  B7:
    return _fast_memcpy<7>(dst, src);
  B8:
    return _fast_memcpy<8>(dst, src);
  B9:
    return _fast_memcpy<9>(dst, src);
  B10:
    return _fast_memcpy<10>(dst, src);
  B11:
    return _fast_memcpy<11>(dst, src);
  B12:
    return _fast_memcpy<12>(dst, src);
  B13:
    return _fast_memcpy<13>(dst, src);
  B14:
    return _fast_memcpy<14>(dst, src);
  B15:
    return _fast_memcpy<15>(dst, src);
  B16:
...
#endif // __SPERM_CC_COMMON_FAST_MEMCPY_H__
